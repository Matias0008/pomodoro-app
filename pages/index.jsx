  ...
  return (
    <>
      <Head>
        ...
        <style
          css
        >{`* {margin: 0;padding: 0;box-sizing: border-box;font-family: "Arial Rounded", sans-serif;}html {font-size: 10px;}@media (max-width: 768px) {html: font-size: 9px;}}.block-scroll {overflow: hidden;}`}</style>
      </Head>
      {loader && <Loader />}
      <Navbar />
      <Pomodoro />
